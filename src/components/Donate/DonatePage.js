  ...
  return (
    <div className="donateContainer">
      ...
      <div className="infoBox">
        ...
        <p>The Muslim community in the Kerr Lake area has, alhamdulillah, grown exponentially in the past few years. The current prayer unit is located in a back alley behind a furniture store in downtown Henderson. The occupant capacity and parking of the current prayer area is unfortunately way below the required number to accommodate our fast-growing community.
